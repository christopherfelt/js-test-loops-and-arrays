  ...
  describe("1. factorials Function", () => {
    ...
    it("returns the correct number given 4", () => {
      chai.assert.strictEqual(
        factorials(4),
        24,
        "Be sure to use the multiplication operator"
      );
    });
  ...
  describe("2. rangeTotal Function", () => {
    ...
    it("returns a number", () => {
      chai.assert.isNumber(
        rangeTotal(1, 3),
        "The return type must be a number."
      );
    });
  ...
  describe("3. rangeDivisor Function", () => {
    ...
    it("returns the correct total of numbers divisible end of range exclusive", () => {
      chai.assert.isAtLeast(
        rangeDivisor(15, 20, 5),
        1,
        "Total divisible numbers in the range exclusive."
      );
    ...
    it("returns the correct total of numbers divisible end of range inclusive", () => {
      chai.assert.strictEqual(
        rangeDivisor(15, 20, 5),
        2,
        "Total divisible numbers in the range inclusive."
      );
    });
  });
});
